...
//Api key
const key ="fca_live_uQZ87XEoD7BtcZYZkWJl6u7XjxdSkHb4BjH7ueUt";
...
//get the list of the available currencies
...
const setupEventsListener = () =>{
    //add the listener when the content is loaded
    ...
    ui.currenciesList.addEventListener("click", selectPair),
...
//filter the array the data currencies array and put it into the filtered currencies array
...
const displayCurrencies =()=>{
    ui.currenciesList.innerHTML = state.filteredCurrencies.map(({code, name})=>{
